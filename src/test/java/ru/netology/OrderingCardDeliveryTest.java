...
import static com.codeborne.selenide.Selenide.open;
    ...
    public class OrderingCardDeliveryTest {
        ...
        @Test
        public void shouldSuccessfullySend() {
        ...
        @Test
        public void shouldBlankLineCity() {
            String planningDate = generateDate(3);
        ...
        public void shouldDeliveryToTheSelectedCityIsNotAvailable() {
            ...
            $("[data-test-id='city'] input").setValue("Сибирская площадь");
            $("[data-test-id='name'] input").setValue("Иван Иванов");
            $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.BACK_SPACE);
            $("[data-test-id='date'] input").setValue(String.valueOf(planningDate));
            $("[data-test-id='phone'] input").setValue("+79133056879");
        ...
        @Test
        public void shouldDeliveryToTheSelectedCityIsNotAvailable1() {
            String planningDate = generateDate(3);
        ...
        @Test
        public void shouldDeliveryToTheSelectedCityIsNotAvailable2() {
            String planningDate = generateDate(3);

            $("[data-test-id='city'] input").setValue("Kemerovosk");
            $("[data-test-id='name'] input").setValue("Иван Иванов");
            $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.BACK_SPACE);
            $("[data-test-id='date'] input").setValue(String.valueOf(planningDate));
            $("[data-test-id='phone'] input").setValue("+79133056879");
        ...
        @Test
        public void shouldDateEnteredIncorrectly() {
        ...
        @Test
        public void shouldOrderForTheSelectedDateIsNotPossible() {
        ...
        @Test
        public void shouldBlankLineName() {
            String planningDate = generateDate(3);
        ...
        @Test
        public void shouldIncorrectlyEnteredName1() {
            String planningDate = generateDate(3);
        ...
        @Test
        public void shouldIncorrectlyEnteredName2() {
            String planningDate = generateDate(3);
